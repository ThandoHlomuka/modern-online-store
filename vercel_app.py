"""
Vercel Serverless Entry Point for Modern Online Store
...
def register():
    ...
    if form.validate_on_submit():
        try:
            ...
            flash('Error creating account. Username or email may already exist.', 'danger')
...
def admin_dashboard():
    ...
    try:
        ...
        total_users = total_products = total_orders = pending_orders = 0
        total_revenue = 0
        recent_orders = []
